...
$stmtFoods = $pdo->query("SELECT food_id, store_id, food_name, food_image_url, price, recommend_reason FROM foods");
        ...
        <div class="workspace">
            ...
            <div class="chat-container">
                ...
                <div class="chat-input-area">
                    ...
                    <button onclick="resetRecommendationState()" style="background: #999; color: white; border: none; padding: 0 15px; font-weight: bold; border-radius: 6px; cursor: pointer; margin-left: 5px;">초기화 🔄</button>
                </div>
            </div>
        </div>
    </div>
